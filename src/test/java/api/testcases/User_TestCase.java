...
//		to log these setup details 
	...
	public void getUserByName()
	{
		...
		Response response=User_requests.readUser(this.userPayload.getUsername());
		response
		.then().log().all();
		Assert.assertEquals(response.getStatusCode(), 200);	
...
//		Update data
		...
		Response response=User_requests.Updateuser(this.userPayload.getUsername(), userPayload);
		response
	...
	public void deleteUser()
	{
		...
		Response response=User_requests.deleteuser(this.userPayload.getUsername());
		response
				.then().log().body().statusCode(200);
		Assert.assertEquals(response.getStatusCode(), 200);
